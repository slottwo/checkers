...
armazena_casa:
    #la s0, tabela        # Endereço base do tabuleiro
    #add s0, s0, t0       # Calcula o endereço da casa
    #sw t6, 0(s0)         # Armazena a cor da casa

    jal ra, loop_impressao_linha
    
    addi t0, t0, 4       # Incrementa o índice do tabuleiro
    addi t2, t2, 1       # Incrementa a coluna
    j loop_colunas

loop_impressao_linha:
    addi t3, t1, 0
    jal ra, impressao
    jal ra, loop_impressao_col
